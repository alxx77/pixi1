...
export class SlotMachine {
  ...
  async initMachine() {
    ...
    let symbol_slot1 = symbol_names.slice(0) //shuffleArray(symbol_names.slice(0));
    let symbol_slot2 =symbol_names.slice(0) //shuffleArray(symbol_names.slice(0));
    let symbol_slot3 =symbol_names.slice(0) //shuffleArray(symbol_names.slice(0));
  ...
  spinReels = async () => {
    ...
    //pokretanje slotova
    this.reel1.spinReel(10);

    setTimeout(() => {
      this.reel2.spinReel(10);
    }, 250);

    setTimeout(() => {
      this.reel3.spinReel(10);
    }, 500);
    ...
    let hit_list = checkTotalHits(reel_matrix,symbol_list);
